 ...
 return (
   ...
   {isOpen && (
        <div className={style.modal_overlay}>
		  ...
		  <div className={style.flex_user}>
		  <div><img src="https://picsum.photos/200/300" alt="" className={Style.user_modal}/></div>
		  <div className={style.datos_user_modal}> {api === undefined ? 'espera': <span className={style.nickname}>{api.user.nickname} <br/>
              {api.types_request.name}</span>}</div>
		  </div>
