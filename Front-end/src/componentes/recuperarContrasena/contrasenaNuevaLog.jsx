...
function ContrasenaNuevaLog() {
    ...
    const [mostrarContrasena, setmostrarContrasena] = useState([false,false,false]);
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className={`contenedor ${style.formulario_registrar}`}>
                     ...
                     <div className={style.inputsPassword}>
                            <div className={style.boton_inputs}>
                                <div className={style.div_input}>
                                    ...
                                    <label className={style.label} htmlFor="password" >
                                        ...
                                        className={style.inputRegister} placeholder="Antigua contraseña"  />
                                        
                                        
                                    </label>
                                    <button className={style.iconEye} onClick={() => setmostrarContrasena([!mostrarContrasena[0],mostrarContrasena[1],mostrarContrasena[2]])}>
                            ...
                            <div className={style.boton_inputs}>
                                <div className={style.div_input}>
                                    ...
                                    <label className={style.label} htmlFor="password1" >
                                        <input id="password1" type={mostrarContrasena[1] ? 'text' : 'password'}
                                        {...register("password1",{ 
                                                required: {
                                                value: true,
                                                message : "La contrasea es requerido"
                                    ...
                                    <button className={style.iconEye} onClick={() => setmostrarContrasena([mostrarContrasena[0],!mostrarContrasena[1]],mostrarContrasena[2])}>
                                            ...
                                            <FontAwesomeIcon className={style.iconEye} icon={mostrarContrasena[1] ? faEye : faEyeSlash} />
                                    </button>
                                </div>
                            ...
                            <label className={style.label} >
                                <input htmlFor="password2" id="password2"  type={mostrarContrasena[2] ? 'text' : 'password'}
                                {...register("password2",{
                                        required: {
                                        value: true,
                            ...
                            <button className={style.iconEye} onClick={() => setmostrarContrasena([mostrarContrasena[0],mostrarContrasena[1],!mostrarContrasena[2]])}>
                                        ...
                                        <FontAwesomeIcon  icon={mostrarContrasena[2] ? faEye : faEyeSlash} />
                                </button>
                            </div>
                            {errors.password2 && <span className={style.error}> {errors.password2.message} </span>}
